...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_a_cube()
    # add test code here
    cube_volume = volume_of_a_cube(3, 4, 5)
    assert_equal(60, cube_volume)
  end

  # Given the radius of a sphere calculate the volume
  def test_volume_of_a_sphere()
    # add test code here
    sphere_volume = volume_of_a_sphere(3)
    assert_equal(113.094, sphere_volume)
  end

  # Given a temperature in degrees farenheit, convert this into celsius.
  def test_convert_fahrenheit_to_celsius()
    # add test code here
    f_to_c = convert_fahrenheit_to_celsius(50)
